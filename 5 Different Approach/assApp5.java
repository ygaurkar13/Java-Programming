 class SY2022bit021{
    public int getValidRegistrationsCount50Approach1(String reg[]) {
        int count = 0;
            ...
            if (temp.length() == 10) {
                ...
                // if (temp1.equals("2022") || temp1.equals("2023") || temp1.equals("2024")) {
                    ...
                    if (temp1.equals("BIT") || temp1.equals("BCS") || temp1.equals("BCE") || temp1.equals("BME")) {
                        ...
                        String max="050";
                        int v1 =max.codePointAt(2);
                        int v2 =max.codePointAt(1);
                        int v3 = temp1.codePointAt(2);
                        int v4 = temp1.codePointAt(1);
                           	if(v1==v3 && v4<=v2){
                           		count++;	
                           	}
